...
iso_name="elytraos"
iso_label="elytraOS_$(date --date="@${SOURCE_DATE_EPOCH:-$(date +%s)}" +%Y%m)"
iso_publisher="Rasenkai"
iso_application="elytraos"
...
file_permissions=(
  ...
  ["/usr/local/bin/elytra-before"]="0:0:755"
  ["/usr/local/bin/skel"]="0:0:755"
  ["/usr/local/bin/all-cores"]="0:0:755"
  ["/usr/local/bin/elytra-final"]="0:0:755"
